...
Run equivalent Pi and Claude tasks with the same profile and compare `byPosture`; token values remain estimates unless provider telemetry is collected separately.
