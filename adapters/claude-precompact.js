...
const PRESERVATION_INSTRUCTIONS =
  'Preserve the current goal, unresolved failures and diagnostics, modified file paths, and every [trim hook: sidecar path. Omit passing logs, resolved diagnostics, and repeated narration.';
